...
namespace GuardaCultura.Models
{
    public class AtratividadesController : Controller
    {
        ...
        public AtratividadesController(GuardaCulturaContext context)// recebe a bd
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Atratividade.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("AtratividadeId,DuracaoId,EstacaoAnoId,MiradouroId")] Atratividade atratividade)
        {
            ...
            {
                // todo: validacoes adicionais antes de inserir a atratividade
